    ...
    <div className={`flex items-center ${collapsed ? 'justify-center' : 'gap-3'}`}>
      ...
      >
        <svg
          ...
          aria-hidden="true"
        >
          <rect x="3" y="3" width="18" height="18" rx="5" stroke="#22d3ee" strokeWidth="1.6" />
          <path d="M8.5 16L12 8L15.5 16" stroke="#e2e8f0" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" />
          <path d="M10 13.1H14" stroke="#e2e8f0" strokeWidth="1.6" strokeLinecap="round" />
        </svg>
      </motion.div>
